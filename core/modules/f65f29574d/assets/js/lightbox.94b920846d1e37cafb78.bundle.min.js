    ...
    [723], {
        ...
        4508: (e, t, n) => {
            ...
            class IconsManager {
                ...
                createSvgNode(e, t) {
                    ...
                    return Object.keys(n).map((e => s[e] = n[e])), Object.keys(i).map((e => s.setAttributeNS(null, e, i[e]))), s
                }
        ...
        3896: (e, t, n) => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                initModal() {
                    const t = {};
                    this.isFontIconSvgExperiment ? t.iconElement = s.close.element : t.iconClass = "eicon-close";
                    const n = e.exports.modal = elementorFrontend.getDialogsManager().createWidget("lightbox", {
                ...
                showModal(e) {
                    ...
                    const s = t.getModal();
                    switch (s.setID(t.getSettings("modalOptions.id")), s.onShow = function() {
                        DialogsManager.getWidgetType("lightbox").prototype.onShow.apply(s, arguments), t.setEntranceAnimation()
                    }, s.onHide = function() {
                        DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(s, arguments), s.getElements("message").removeClass("animated"), i.default.isFullscreen && t.deactivateFullscreen(), t.unbindHotKeys()
                    }, e.type) {
                        case "video":
                            t.setVideoContent(e);
                            break;
                ...
                setVideoContent(e) {
                    ...
                    const i = this.getSettings("classes"),
                        ...
                        r = t("<div>", {
                            class: `${i.videoWrapper} elementor-video-${this.getRatioType(s)}`,
                    ...
                    const a = l.onHide;
                    l.onHide = function() {
                        a(), this.$buttons = jQuery(), this.focusedButton = null, l.getElements("message").removeClass("elementor-video-wrapper")
                    }
                },
                getRatioDictionry: e => ({
                    219: 2.33333,
                ...
                getShareLinks() {
                    const {
                        ...
                        facebook: {
                            ...
                            iconElement: s.facebook
                        },
                        twitter: {
                            label: e.shareOnTwitter,
                            iconElement: s.twitter
                        },
                        pinterest: {
                            label: e.pinIt,
                            iconElement: s.pinterest
                        }
                    }, n = jQuery, i = this.getSettings("classes"), o = this.getSettings("selectors"), r = n("<div>", {
                        class: i.slideshow.shareLinks
                    }), l = this.getSlide("active"), a = l.find(o.image), d = l.data("elementor-slideshow-video");
                    let c;
                    if (c = d || a.attr("src"), n.each(t, ((e, t) => {
                            const i = t.label,
                                s = n("<a>", {
                                    href: this.createShareLink(e, c, l.attr("data-e-action-hash")),
                                    target: "_blank"
                                }).text(i),
                                o = this.isFontIconSvgExperiment ? n(t.iconElement.element) : n("<i>", {
                                    class: "eicon-" + e,
                                    "aria-hidden": "true"
                                });
                            s.prepend(o), r.append(s)
                        })), !d) {
                        const t = this.isFontIconSvgExperiment ? n(s.downloadBold.element) : n("<i>", {
                            class: "eicon-download-bold"
                        });
                        t.attr("aria-label", e.download), r.append(n("<a>", {
                            href: c,
                            download: ""
                ...
                createShareLink(e, t) {
                    ...
                    const i = {};
                    return "pinterest" === e ? i.image = encodeURIComponent(t) : i.url = encodeURIComponent(location.href.replace(/#.*/, "") + n), ShareLink.getNetworkLink(e, i)
                },
                getSlideshowHeader() {
                    const {
                        i18n: e
                    } = elementorFrontend.config, t = jQuery, n = "yes" === elementorFrontend.getKitSettings("lightbox_enable_counter"), i = "yes" === elementorFrontend.getKitSettings("lightbox_enable_fullscreen"), o = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom"), r = "yes" === elementorFrontend.getKitSettings("lightbox_enable_share"), l = this.getSettings("classes"), a = l.slideshow, d = this.elements;
                    if (n || i || o || r) {
                        if (d.$header = t("<header>", {
                                class: a.header + " " + l.preventClose
                            }), r) {
                            const n = this.isFontIconSvgExperiment ? s.shareArrow.element : "<i>";
                            d.$iconShare = t(n, {
                                class: a.iconShare,
                                role: "button",
                                tabindex: 0,
                        ...
                        if (o) {
                            const n = this.isFontIconSvgExperiment ? s.zoomInBold.element : "<i>",
                                i = [],
                                o = {
                                    role: "switch",
                                    tabindex: 0,
                            ...
                            this.isFontIconSvgExperiment || (r.class = a.iconZoomIn), d.$iconZoom = t(n).attr(r).on("click", this.toggleZoomMode), i.push(d.$iconZoom), this.isFontIconSvgExperiment && (d.$iconZoomOut = t(s.zoomOutBold.element).attr(o).addClass(l.hidden).on("click", this.toggleZoomMode), i.push(d.$iconZoomOut)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                        if (i) {
                            const n = this.isFontIconSvgExperiment ? s.frameExpand.element : "<i>",
                                i = [],
                                o = {
                                    role: "switch",
                                    tabindex: 0,
                            ...
                            this.isFontIconSvgExperiment || (r.class = a.iconExpand), d.$iconExpand = t(n).append(t("<span>"), t("<span>")).attr(r).on("click", this.toggleFullscreen), i.push(d.$iconExpand), this.isFontIconSvgExperiment && (d.$iconMinimize = t(s.frameMinimize.element).attr(o).addClass(l.hidden).on("click", this.toggleFullscreen), i.push(d.$iconMinimize)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                        return n && (d.$counter = t("<span>", {
                            class: a.counter
                ...
                activateZoom() {
                    ...
                    e.zoom.in(), e.allowSlideNext = !1, e.allowSlidePrev = !1, e.allowTouchMove = !1, t.$container.addClass(n.slideshow.zoomMode), this.isFontIconSvgExperiment ? (t.$iconZoom.addClass(n.hidden).attr("aria-checked", "false"), t.$iconZoomOut.removeClass(n.hidden).attr("aria-checked", "true")) : t.$iconZoom.removeClass(n.slideshow.iconZoomIn).addClass(n.slideshow.iconZoomOut)
                },
                deactivateZoom() {
                    const e = this.swiper,
                        t = this.elements,
                        n = this.getSettings("classes");
                    e.zoom.out(), e.allowSlideNext = !0, e.allowSlidePrev = !0, e.allowTouchMove = !0, t.$container.removeClass(n.slideshow.zoomMode), this.isFontIconSvgExperiment ? (t.$iconZoom.removeClass(n.hidden).attr("aria-checked", "true"), t.$iconZoomOut.addClass(n.hidden).attr("aria-checked", "false")) : t.$iconZoom.removeClass(n.slideshow.iconZoomOut).addClass(n.slideshow.iconZoomIn)
                },
                getSlideshowFooter() {
                    const e = jQuery,
                ...
                setSlideshowContent(e) {
                    const {
                        i18n: t
                    } = elementorFrontend.config, n = jQuery, i = 1 === e.slides.length, o = "" !== elementorFrontend.getKitSettings("lightbox_title_src"), r = "" !== elementorFrontend.getKitSettings("lightbox_description_src"), l = o || r, a = this.getSettings("classes"), d = a.slideshow, c = n("<div>", {
                        class: d.container
                    }), h = n("<div>", {
                    ...
                    if (e.slides.forEach((e => {
                            ...
                            if (e.video) {
                                ...
                                const i = this.isFontIconSvgExperiment ? s.loading.element : "<i>",
                                    r = n("<div>", {
                                        class: a.playButton
                                    }).html(n(i).attr("aria-label", t.playVideo).addClass(a.playButtonIcon));
                                o.append(r)
                            } else {
                                const t = n("<div>", {
                                ...
                                e.title && (s["data-title"] = e.title, s.alt = e.title), e.description && (s["data-description"] = e.description, s.alt += " - " + e.description);
                                const r = n("<img>", s);
                        ...
                        const e = this.isFontIconSvgExperiment ? n(s.chevronLeft.element) : n("<i>", {
                                class: d.prevButtonIcon,
                                "aria-hidden": "true"
                            }),
                            i = this.isFontIconSvgExperiment ? n(s.chevronRight.element) : n("<i>", {
                        ...
                        }).append(i, r), c.append(p, m), this.$buttons = this.$buttons.add(p).add(m)
                    }
                    l && (this.elements.$footer = this.getSlideshowFooter(), c.append(this.elements.$footer)), this.setSettings("hideUiTimeout", ""), c.on("click mousemove keypress", this.showLightboxUi);
                    ...
                    u.onShow = async () => {
                        ...
                        this.swiper = await new s(c, t), c.data("swiper", this.swiper), this.playSlideVideo(), l && this.updateFooterText(), this.bindHotKeys(), this.makeButtonsAccessible()
                    }
                },
                ...
                activeKeyDown(e) {
                    ...
                    if (9 === e.which) {
                        ...
                        t.each((e => {
                            const o = t[e];
                            if (jQuery(o).is(":focus")) return n = o, i = 0 === e, s = t.length - 1 === e, !1
                        })), e.shiftKey ? i && (e.preventDefault(), t.last().trigger("focus")) : !s && n || (e.preventDefault(), t.first().trigger("focus"))
                    }
                },
                getSlide(e) {
                ...
                playSlideVideo() {
                    ...
                    const n = this.getSettings("classes"),
                        i = this.getRatioDictionry(this.getSettings("modalOptions.videoAspectRatio")),
                        s = jQuery("<div>", {
                            class: n.videoContainer + " " + n.invisible
                        }),
                        o = jQuery("<div>", {
                            class: `${n.videoWrapper} elementor-video-${this.getRatioType(i)}`,
                            style: "--video-aspect-ratio: " + i
                        }),
                        r = e.children("." + n.playButton);
                    let l, a;
                    s.append(o), e.append(s), -1 !== t.indexOf("vimeo.com") ? (l = "vimeo", a = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (l = "youtube", a = elementorFrontend.utils.youtube);
                    const d = a.getVideoIDFromURL(t);
                    a.onApiReady((e => {
                        "youtube" === l ? this.prepareYTVideo(e, d, s, o, r) : "vimeo" === l && this.prepareVimeoVideo(e, t, s, o, r)
                ...
                prepareYTVideo(e, t, n, i, s) {
                    ...
                    i.append(r), window.chrome && (l = e.PlayerState.UNSTARTED), n.addClass("elementor-loading " + o.invisible), this.player = new e.Player(r[0], {
                        videoId: t,
                        events: {
                            onReady: () => {
                                s.addClass(o.hidden), n.removeClass(o.invisible), this.player.playVideo()
                            },
                            onStateChange: e => {
                                e.data === l && n.removeClass("elementor-loading " + o.invisible)
                            }
                        },
                        playerVars: {
                            controls: 0,
                ...
                openSlideshow(e, t) {
                    const n = jQuery(this.getSettings("selectors.links")).filter(((t, n) => {
                            const i = jQuery(n);
                    ...
                    n.each((function() {
                        ...
                        void 0 === o && (o = n.index(this)), (t === this.href || e && t === e) && (s = o);
                        const r = {
                            image: this.href,
                            index: o,
                    ...
                    o = {
                        request(e) {
                            return new Promise(function(n, s) {
                                ...
                                this.on("change", o), e = e || t.documentElement, Promise.resolve(e[i.requestFullscreen]()).catch(s)
                            }.bind(this))
                        },
                        exit() {
                            return new Promise(function(e, n) {
                                if (this.isFullscreen) {
                                    ...
                                    this.on("change", s), Promise.resolve(t[i.exitFullscreen]()).catch(n)
                                } else e()
                            }.bind(this))
                        },
                        toggle(e) {
