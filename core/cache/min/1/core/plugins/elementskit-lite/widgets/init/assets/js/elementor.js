! function(e, t) {
    ...
    window.ElementsKit_Helper = {}, ElementsKit_Helper.setURLHash = function(t, n, i) {
        ...
        let n = t.find(".elementskit-submenu-indicator, .ekit-submenu-indicator-icon"),
            ...
            o = n.attr("class"),
            a = "elementskit-submenu-indicator eicon-loading eicon-animation-spin";
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                t.addClass("ekit-ajax-loading"), n.removeClass(o).addClass(a), e(document).width() <= Number(s) ? n.css({
                    border: "none"
                }) : n.css({
                    "padding-right": 0,
                    "margin-right": "5px"
            ...
            success: function(s) {
                t.removeClass("ekit-ajax-loading"), i.replaceWith(s), n.removeClass(a).addClass(o).removeAttr("style"), t.find(".elementor-element").each((function() {
        ...
        Nav_Menu: function(t) {
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(i) {
                    ...
                    let s = e(this).parent(),
                        o = e(this).parents(".elementskit-dropdown-has"),
                        a = s.find(">.elementskit-dropdown, >.elementskit-megamenu-panel");
                    t.find(".elementskit-dropdown-has").not(o).find(">.elementskit-dropdown, >.elementskit-megamenu-panel").removeClass("ekit-dropdown-open-onclick"), a.toggleClass("ekit-dropdown-open-onclick")
                })), e(window).on("resize", (function() {
        ...
        Countdown_Timer: function(t) {
            ...
            if (l.length) {
                ...
                l.theFinalCountdown(d.ekitCountdown, (function(e) {
                    m(c.s, e.offset.seconds, s), m(c.m, e.offset.minutes, i), m(c.h, e.offset.hours, o), m(c.d, e.offset.days, a), m(c.w, e.offset.weeks, r), c.s = e.offset.seconds, c.m = e.offset.minutes, c.h = e.offset.hours, c.d = e.offset.days, c.w = e.offset.weeks
                })).on("finish.countdown", (function() {
